...
if __name__ == '__main__':
    ...
    imgs_cp = [np.stack((img[[0,1]].sum(axis=0), img[3]), axis=0) for name, img in images_dict.items()]
    ...
    # ---------------- apply cellpose ----------------
    masks, flows, styles = apply_cellpose(imgs_cp, niter=2000, diameter=200, big_images=True)
